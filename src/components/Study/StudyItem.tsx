  ...
  return (
    <div className={`group flex gap-6`}>
      <div className="relative flex flex-col items-center justify-start">
        <div className="h-8 w-8 rounded-full border-8 border-solid border-[#9BC3DE] bg-transparent transition-colors duration-150 ease-in-out group-hover:bg-[#9BC3DE]" />
        {!isFinal && (
